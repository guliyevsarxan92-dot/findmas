  ...
  return (
    <View style={s.wrap}>
      ...
      <View style={[
        ...
        props.multiline && { height: 110, alignItems: 'flex-start' },
      ]}>
        ...
        <TextInput
          style={[
            s.input,
            icon && { paddingLeft: 0 },
            props.multiline && { paddingTop: 12, textAlignVertical: 'top' },
          ]}
...
const s = StyleSheet.create({
  ...
  icon: { opacity: 0.6 },
  input: { flex: 1, fontSize: 15, color: C.dark, fontWeight: '500' },
