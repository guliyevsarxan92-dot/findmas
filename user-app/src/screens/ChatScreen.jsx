  ...
  function renderMesaj({ item }) {
    ...
    return (
      <View style={[s.mesajWrap, ozumunkudur ? s.sagda : s.solda]}>
        <View style={[s.mesajBalon, ozumunkudur ? s.ozBalon : s.onunBalon]}>
...
const s = StyleSheet.create({
  ...
  mesajBalon: { borderRadius: 18, padding: 12 },
  ozBalon: { backgroundColor: C.primary, borderBottomRightRadius: 4 },
  onunBalon: { backgroundColor: C.white, borderBottomLeftRadius: 4, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 4, elevation: 1 },
  mesajMetn: { fontSize: 15, color: C.text, lineHeight: 21 },
  saat: { fontSize: 11, color: C.textSoft, marginTop: 3, marginHorizontal: 4 },
  input: {
  ...
  textInput: {
    ...
    paddingVertical: 10, fontSize: 15, color: C.text, maxHeight: 100,
  },
